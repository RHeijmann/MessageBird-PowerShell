...
#################### Belangrijk!
#Voordat u dit script gebruikt, moet er binnen Internet Explorer gekozen worden of de standaard instellingen gebruikt moeten worden.
...
Else {
	Write-Host("ERROR: Er konden geen contacten gevonden worden.")
}
